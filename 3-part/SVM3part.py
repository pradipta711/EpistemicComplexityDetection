...
class SVM3partC:
    ...
    def __init__(self):
        print("Inside constructor SVM3part")
    ...
    def execute3part(self):
        ...
        y_predFE = linearSVM.predict(X_testFE)
        ...
        linearSVM1 = LinearSVC(random_state=0, tol=1e-5)
        linearSVM1.fit(X1, y1)

        y_predEFE = linearSVM1.predict(X_testEFE)
        ...
        linearSVM2 = LinearSVC(random_state=0, tol=1e-5)
        linearSVM2.fit(X2, y2)

        y_predEEE = linearSVM2.predict(X_testEEE)
